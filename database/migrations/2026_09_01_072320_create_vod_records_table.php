...
{
    /**
     * One stored player video recording (VOD) per Session Participant. Written
    ...
    {
        Schema::create('vod_records', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('vod_records');
    }
};
